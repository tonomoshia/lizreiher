...
tags: [AI, Agentic AI, Prototyping, Innovation, TechHub, Learning]
...
- **Mark Tennenhouse** built a *Piano Learning System Origin*—a game that teaches piano by using it as a controller. Think *Flappy Bird*, but you keep the bird aloft by playing the right notes. He re-engineered the controls so music drives motion.  
  👉 [marktennenhouse.github.io/html-games/flappy-bird/index.html](https://marktennenhouse.github.io/html-games/flappy-bird/index.html)
...
- **Michael Medina** shared *Cyclopedia*, his passion project turned professional-grade hurricane database. With help from Cursor, he migrated it to Next.js for server-side rendering and performance optimization.  
  👉 [github.com/mikematics22800/Cyclopedia-Next.js](https://github.com/mikematics22800/Cyclopedia-Next.js)  
  His reflection stuck with me: *“All those bad ideas I shelved for years—AI turned them into weekend projects.”*

### The Big Picture

That final thought summed up the day. The bootcamp wasn’t about becoming AI experts—it was about *building momentum.* Trying things, breaking things, learning what works, and realizing that progress doesn’t require perfection.  
